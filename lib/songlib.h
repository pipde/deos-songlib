#ifndef __SONGLIB_INCLUDED__
#define __SONGLIB_INCLUDED__
...
extern int *readStrings(char *,char *,int);
...
extern void beginRitardando(double);
extern void endRitardando(void);
extern void beginAccelerando(double);
extern void endAccelerando(void);
...
extern int getStrideMode(void);
extern int setStrideMode(int);
extern double setStrideSlop(double);

extern int getStrumDirection(void);
extern int setStrumDirection(int);
