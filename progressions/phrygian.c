...
main()
    ...
    // a progression
    //      suggested: c1
    //      suggested: at least one of c2, c5, and c7
    //      suggested: at least one of c3, c4, and c6
